...
import avgreport.mobitv.net.vn.config.audit.AuditEventConverter;
import avgreport.mobitv.net.vn.domain.PersistentAuditEvent;
...
import static avgreport.mobitv.net.vn.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
